...
public class ShippingCostController {
    ...
    public ResponseEntity<ShippingCostResponse> createShippingCost(@RequestBody ShippingCostRequest request) {
    ...
    public ResponseEntity<ShippingCostResponse> updateShippingCost(@PathVariable("id") Long id, @RequestBody ShippingCostRequest request) {
