...
public class StatisticalReportController {
    ...
    public ApiResponse<Page<StatisticalReportResponse>> getByDate(
        ...
        Page<StatisticalReportResponse> statisticalReport =
            statisticalReportService.getStatisticalReportByDate(
                date,
                page,
                size
            );
    ...
    public ApiResponse<Page<StatisticalReportResponse>> getByMonth(
        ...
        Page<StatisticalReportResponse> statisticalReport =
            statisticalReportService.getStatisticalReportByMonth(
                month,
                page,
                size
            );
    ...
    public ApiResponse<Page<OrderResponse>> getByDateAndType(
        ...
        Page<OrderResponse> orders =
            statisticalReportService.getStatisticalReportByDateAndType(
                date,
                type,
                page,
                size
    ...
    public ApiResponse<Page<OrderResponse>> getByMonthAndType(
        ...
        Page<OrderResponse> orders =
            statisticalReportService.getStatisticalReportByMonthAndType(
                month,
                type,
                page,
                size
    ...
    public ApiResponse<StatisticalReportRevenueResponse> getRevenueByDate(
        ...
        StatisticalReportRevenueResponse statisticalReport =
            statisticalReportService.getRevenueByDate(date);
    ...
    public ApiResponse<StatisticalReportRevenueResponse> getRevenueByMonth(
        ...
        StatisticalReportRevenueResponse statisticalReport =
            statisticalReportService.getRevenueByDate(month);
        return new ApiResponse<StatisticalReportRevenueResponse>(
            200,
            null,
            statisticalReport
    ...
    public ApiResponse<List<Report>> getRevenueByMinAndMaxDate(
        ...
        List<Report> statisticalReport =
            statisticalReportService.getRevenueByMinAndMaxDate(minDate, maxDate, storeId);
    ...
    public ApiResponse<Report> getRevenueByDate(
        ...
        Report statisticalReport =
            statisticalReportService.getRevenueByDate(date, storeId);
