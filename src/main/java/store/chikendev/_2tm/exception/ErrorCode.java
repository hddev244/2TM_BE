...
public enum ErrorCode {
    ...
    NO_MANAGEMENT_RIGHTS(
        418,
        "Đơn hàng này hiện không thuộc quản lý của bạn",
        HttpStatus.BAD_REQUEST
    ),
    ...
    ORDER_NOT_FOUND(
        434,
        "Tông tin order không chính xác",
        HttpStatus.BAD_REQUEST
    ),
    ...
    QUANTITY_ERROR(
        437,
        "Số lượng vượt quá số hàng tồn kho",
        HttpStatus.BAD_REQUEST
    ),
    DELIVERY_PERSON_NOT_FOUND(
        438,
        "Khu vực của bạn không hỗ trợ lấy hàng",
        HttpStatus.BAD_REQUEST
    ),
    PAYMENT_ERROR(439, "Thanh toán không thành công", HttpStatus.BAD_REQUEST),
    CONSIGNMENT_ORDER_NOT_FOUND(
        440,
    ...
    STATE_ERROR(
        461,
        "Trạng thái không phù hợp để thay đổi",
        HttpStatus.BAD_REQUEST
    ),
    ...
    PAYMENT_RECORD_NOT_FOUND(
        457,
        "Không tìm thấy hóa đơn thanh toán",
        HttpStatus.BAD_REQUEST
    ),
    CART_ITEM_NOT_MATCHING_ACCOUNT(
        456,
        "Sản phẩm trong giỏ hàng không phù hợp với tài khoản",
        HttpStatus.BAD_REQUEST
    ),
    ORDER_NOT_CONFIRMED(455, "Đơn hàng chưa xác nhận", HttpStatus.BAD_REQUEST),
    DELIVERY_PERSON_EMPTY(
        454,
        "Không tìm thấy nhân viên giao hàng",
        HttpStatus.BAD_REQUEST
    ),
    STATE_ORDER_NOT_FOUND(
        453,
        "Không tìm thấy trạng thái order",
        HttpStatus.BAD_REQUEST
    ),
    ROLE_ERROR(
        452,
        "Vai trò không phù hợp để thực hiện chức năng",
        HttpStatus.BAD_REQUEST
    ),
    BILL_OF_LADING_NOT_FOUND(
        462,
        "Không tìm thấy vận đơn",
        HttpStatus.BAD_REQUEST
    ),
    INVALID_STATUS_CHANGE(
        463,
        "Trạng thái thay đổi không phù hợp",
        HttpStatus.BAD_REQUEST
    ),
    ...
    PAYMENT_ERROR_10(
        473,
        "bạn xác thực thông tin thẻ/tài khoản không đúng quá 3 lần",
        HttpStatus.BAD_REQUEST
    ),
    PAYMENT_ERROR_11(474, "Đã hết hạn chờ thanh toán", HttpStatus.BAD_REQUEST),
    PAYMENT_ERROR_12(
        475,
        "Thẻ/Tài khoản của bạn bị khóa",
        HttpStatus.BAD_REQUEST
    ),
    PAYMENT_ERROR_24(476, "Bạn đã hủy giao dịch", HttpStatus.BAD_REQUEST),
    PAYMENT_ERROR_79(
        477,
        "Bạn nhập sai mật khẩu thanh toán quá số lần quy định",
        HttpStatus.BAD_REQUEST
    ),
    PAYMENT_ERROR_65(
        478,
    ...
    PAYMENT_ERROR_99(
        480,
        "Thanh toán bị lỗi không xác định",
        HttpStatus.BAD_REQUEST
    ),
    ...
    UNAUTHORIZED(
        401,
        "Thông tin xác nhận không hợp lệ",
        HttpStatus.UNAUTHORIZED
    ),
    TOKEN_EXPIRED(402, "Phiên đăng nhập đã hết hạn", HttpStatus.UNAUTHORIZED),
    TOKEN_FORGOT_EXPIRED(402, "Token hết hạn", HttpStatus.FORBIDDEN),
    FILE_NOT_FOUND(
        429,
        "Bạn không thể bỏ trống ảnh trong mục này",
        HttpStatus.BAD_REQUEST
    ),
    ORDER_ERROR(
        447,
        "Order xảy ra lỗi, vui lòng thử lại sau!",
        HttpStatus.BAD_REQUEST
    ),
    ...
    CART_QTY_BIGGER_THAN_PRODUCT(
        450,
        "Số lượng sản phẩm trong giỏ hàng lớn hơn số lượng sản phẩm tồn kho",
        HttpStatus.BAD_REQUEST
    ),
