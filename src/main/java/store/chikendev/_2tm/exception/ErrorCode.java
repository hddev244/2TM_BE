...
public enum ErrorCode {
        ...
        ACCOUNT_NOT_IN_STORE(426, "Nhân viên chưa được phân công làm việc tại cửa hàng nào.", HttpStatus.BAD_REQUEST),
        ...
        INVALID_COMMISSION_RATE(464, "Tỷ lệ hoa hồng phải >= 10%", HttpStatus.BAD_REQUEST),
